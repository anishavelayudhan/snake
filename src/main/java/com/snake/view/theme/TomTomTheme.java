...
public class TomTomTheme implements Theme {
    private static final Color SNAKE_COLOR = new Color(0, 166, 94);
    private static final Color APPLE_COLOR = new Color(223, 27, 18);
    private static final Color GRID_COLOR_1 = new Color(255, 255, 255);
    private static final Color GRID_COLOR_2 = new Color(242, 242, 242);
    private static final Color BACKGROUND_COLOR = new Color(255, 255, 255);
    private static final Color PANEL_COLOR_1 = new Color(223, 27, 18);
    private static final Color PANEL_COLOR_2 = new Color(255, 255, 255);
